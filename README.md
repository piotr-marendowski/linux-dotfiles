...
### While this is the base branch, and was used by me for a while, the updated and focused on integration with the [IvoryOS](https://github.com/piotr-marendowski/ivoryos) is the [DWM branch](https://github.com/piotr-marendowski/dotfiles/tree/dwm).
